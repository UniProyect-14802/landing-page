  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-card to-primary/5 rounded-3xl p-8 shadow-elegant border border-border/50 animate-fade-in-up hover:shadow-primary transition-all duration-500" style={{animationDelay: '0.1s'}}>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-background/50 border border-border/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 text-foreground placeholder:text-muted-foreground"
            ...
            <Button 
              ...
              variant="hero" 
              size="lg" 
              className="w-full text-lg py-6 h-auto hover:scale-105 transition-transform duration-300"
            >
              {t.signIn}
            </Button>
          </form>
          ...
          <div className="space-y-3">
            <Button 
              variant="outline" 
              className="w-full py-3 h-auto hover:bg-primary/5 transition-colors duration-300"
